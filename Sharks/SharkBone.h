...
class SharkBone
{
	...
	private:
		...
		Matrix transMatHeir;   //apply this translation to the stack.           translates from boneLength
		Matrix transMatLocal;      //only apply this translation to this bone.  translates from startB and endB
		Matrix jointTrans;     //any custom trans add here. Possibly hacky.
